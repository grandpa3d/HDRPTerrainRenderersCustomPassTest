...
Shader "Grandpa3D/HDRP/Terrain/Alternating Colors"
{
	Properties
	{
		...
		_StripeResolution("Stripe Resolution", Range( 0 , 5)) = 0.2
		_MajorIndex("Major Index", Int) = 10
		_MinorIndex("Minor Index", Int) = 5
	...
	UsePass "Hidden/Nature/Terrain/Utilities/SELECTION"
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float2 vertexToFrag286_g7 = ( ( inputMesh.ase_texcoord.xy * _Control_ST.xy ) + appendResult293_g7 );
				outputPackedVaryingsMeshToPS.ase_texcoord6.xy = vertexToFrag286_g7;
				float2 break951_g7 = _Control1_ST.zw;
				float2 appendResult956_g7 = (float2(( break951_g7.x + 0.001 ) , ( break951_g7.y + 0.0001 )));
				float2 vertexToFrag958_g7 = ( ( inputMesh.ase_texcoord.xy * _Control1_ST.xy ) + appendResult956_g7 );
				outputPackedVaryingsMeshToPS.ase_texcoord7.xy = vertexToFrag958_g7;
						...
						)
			{
				...
				float vertexPositionY22_g4 = packedInput.ase_texcoord5.xyz.y;
				float stripeResolution3_g4 = _StripeResolution;
				float currentContour34_g4 = ceil( ( vertexPositionY22_g4 * stripeResolution3_g4 ) );
				float currentColor65_g4 = ( 1.0 - ( currentContour34_g4 % 2.0 ) );
				int minorIndex30_g4 = _MajorIndex;
				float currentMinor69_g4 = ( ( currentContour34_g4 % (float)minorIndex30_g4 ) == 0.0 ? 1.0 : 0.0 );
				int majorIndex31_g4 = _MinorIndex;
				float currentMajor76_g4 = ( ( currentContour34_g4 % (float)majorIndex31_g4 ) == 0.0 ? 1.0 : 0.0 );
				float4 appendResult59_g4 = (float4(currentColor65_g4 , currentMinor69_g4 , 0.0 , currentMajor76_g4));
				float4 temp_output_1362_0 = appendResult59_g4;
				
				float2 vertexToFrag286_g7 = packedInput.ase_texcoord6.xy;
				float4 Control26_g7 = SAMPLE_TEXTURE2D( _Control, sampler_Control, vertexToFrag286_g7 );
				float2 uv_Splat0 = packedInput.ase_texcoord6.zw * _Splat0_ST.xy + _Splat0_ST.zw;
				float4 Normal0341_g7 = SAMPLE_TEXTURE2D( _Normal0, sampler_Normal0, uv_Splat0 );
				...
				float2 uv_Splat1 = packedInput.ase_texcoord6.zw * _Splat1_ST.xy + _Splat1_ST.zw;
				float4 Normal1378_g7 = SAMPLE_TEXTURE2D( _Normal1, sampler_Normal0, uv_Splat1 );
				...
				float2 uv_Splat2 = packedInput.ase_texcoord6.zw * _Splat2_ST.xy + _Splat2_ST.zw;
				float4 Normal2356_g7 = SAMPLE_TEXTURE2D( _Normal2, sampler_Normal0, uv_Splat2 );
				...
				float2 uv_Splat3 = packedInput.ase_texcoord6.zw * _Splat3_ST.xy + _Splat3_ST.zw;
				float4 Normal3398_g7 = SAMPLE_TEXTURE2D( _Normal3, sampler_Normal0, uv_Splat3 );
				...
				float2 vertexToFrag958_g7 = packedInput.ase_texcoord7.xy;
				float4 Control1922_g7 = SAMPLE_TEXTURE2D( _Control1, sampler_Control1, vertexToFrag958_g7 );
				float2 uv_Splat4 = packedInput.ase_texcoord6.zw * _Splat4_ST.xy + _Splat4_ST.zw;
				float4 Normal4746_g7 = SAMPLE_TEXTURE2D( _Normal4, sampler_Normal4, uv_Splat4 );
				...
				float2 uv_Splat5 = packedInput.ase_texcoord6.zw * _Splat5_ST.xy + _Splat5_ST.zw;
				float4 Normal5740_g7 = SAMPLE_TEXTURE2D( _Normal5, sampler_Normal0, uv_Splat5 );
				...
				float2 uv_Splat6 = packedInput.ase_texcoord6.zw * _Splat6_ST.xy + _Splat6_ST.zw;
				float4 Normal6754_g7 = SAMPLE_TEXTURE2D( _Normal6, sampler_Normal0, uv_Splat6 );
				...
				float2 uv_Splat7 = packedInput.ase_texcoord6.zw * _Splat7_ST.xy + _Splat7_ST.zw;
				float4 Normal7764_g7 = SAMPLE_TEXTURE2D( _Normal7, sampler_Normal0, uv_Splat7 );
				...
				float3 staticSwitch503_g7 = appendResult514_g7;
				#else
				float3 staticSwitch503_g7 = appendResult514_g7;
				#endif
				
				float4 tex2DNode416_g7 = SAMPLE_TEXTURE2D( _Mask0, sampler_Mask0, uv_Splat0 );
				float Mask0R334_g7 = tex2DNode416_g7.r;
				float4 tex2DNode422_g7 = SAMPLE_TEXTURE2D( _Mask1, sampler_Mask0, uv_Splat1 );
				float Mask1R370_g7 = tex2DNode422_g7.r;
				float4 tex2DNode419_g7 = SAMPLE_TEXTURE2D( _Mask2, sampler_Mask0, uv_Splat2 );
				float Mask2R359_g7 = tex2DNode419_g7.r;
				float4 tex2DNode425_g7 = SAMPLE_TEXTURE2D( _Mask3, sampler_Mask0, uv_Splat3 );
				float Mask3R388_g7 = tex2DNode425_g7.r;
				float4 weightedBlendVar536_g7 = Control26_g7;
				float weightedBlend536_g7 = ( weightedBlendVar536_g7.x*( ( 1.0 - _Metallic0 ) * Mask0R334_g7 ) + weightedBlendVar536_g7.y*( ( 1.0 - _Metallic1 ) * Mask1R370_g7 ) + weightedBlendVar536_g7.z*( ( 1.0 - _Metallic2 ) * Mask2R359_g7 ) + weightedBlendVar536_g7.w*( ( 1.0 - _Metallic3 ) * Mask3R388_g7 ) );
				float4 tex2DNode697_g7 = SAMPLE_TEXTURE2D( _Mask4, sampler_Mask4, uv_Splat4 );
				float Mask4R747_g7 = tex2DNode697_g7.r;
				float4 tex2DNode704_g7 = SAMPLE_TEXTURE2D( _Mask5, sampler_Mask0, uv_Splat5 );
				float Mask5R741_g7 = tex2DNode704_g7.r;
				float4 tex2DNode711_g7 = SAMPLE_TEXTURE2D( _Mask6, sampler_Mask0, uv_Splat6 );
				float Mask6R755_g7 = tex2DNode711_g7.r;
				float4 tex2DNode717_g7 = SAMPLE_TEXTURE2D( _Mask7, sampler_Mask0, uv_Splat7 );
				float Mask7R765_g7 = tex2DNode717_g7.r;
				float4 weightedBlendVar834_g7 = Control1922_g7;
				float weightedBlend834_g7 = ( weightedBlendVar834_g7.x*( ( 1.0 - _Metallic4 ) * Mask4R747_g7 ) + weightedBlendVar834_g7.y*( ( 1.0 - _Metallic5 ) * Mask5R741_g7 ) + weightedBlendVar834_g7.z*( ( 1.0 - _Metallic6 ) * Mask6R755_g7 ) + weightedBlendVar834_g7.w*( ( 1.0 - _Metallic7 ) * Mask7R765_g7 ) );
				
				float Mask0A335_g7 = tex2DNode416_g7.a;
				float Mask1A369_g7 = tex2DNode422_g7.a;
				float Mask2A360_g7 = tex2DNode419_g7.a;
				float Mask3A391_g7 = tex2DNode425_g7.a;
				float4 weightedBlendVar547_g7 = Control26_g7;
				float weightedBlend547_g7 = ( weightedBlendVar547_g7.x*( ( 1.0 - _Smoothness0 ) * Mask0A335_g7 ) + weightedBlendVar547_g7.y*( ( 1.0 - _Smoothness1 ) * Mask1A369_g7 ) + weightedBlendVar547_g7.z*( ( 1.0 - _Smoothness2 ) * Mask2A360_g7 ) + weightedBlendVar547_g7.w*( ( 1.0 - _Smoothness3 ) * Mask3A391_g7 ) );
				float Mask4A750_g7 = tex2DNode697_g7.a;
				float Mask5A745_g7 = tex2DNode704_g7.a;
				float Mask6A758_g7 = tex2DNode711_g7.a;
				float Mask7A768_g7 = tex2DNode717_g7.a;
				float4 weightedBlendVar826_g7 = Control1922_g7;
				float weightedBlend826_g7 = ( weightedBlendVar826_g7.x*( ( 1.0 - _Smoothness4 ) * Mask4A750_g7 ) + weightedBlendVar826_g7.y*( ( 1.0 - _Smoothness5 ) * Mask5A745_g7 ) + weightedBlendVar826_g7.z*( ( 1.0 - _Smoothness6 ) * Mask6A758_g7 ) + weightedBlendVar826_g7.w*( ( 1.0 - _Smoothness7 ) * Mask7A768_g7 ) );
				
				float Mask0G409_g7 = tex2DNode416_g7.g;
				float Mask1G371_g7 = tex2DNode422_g7.g;
				float Mask2G358_g7 = tex2DNode419_g7.g;
				float Mask3G389_g7 = tex2DNode425_g7.g;
				float4 weightedBlendVar602_g7 = Control26_g7;
				float weightedBlend602_g7 = ( weightedBlendVar602_g7.x*saturate( ( ( ( Mask0G409_g7 - 0.5 ) * 0.25 ) + ( 1.0 - 0.25 ) ) ) + weightedBlendVar602_g7.y*saturate( ( ( ( Mask1G371_g7 - 0.5 ) * 0.25 ) + ( 1.0 - 0.25 ) ) ) + weightedBlendVar602_g7.z*saturate( ( ( ( Mask2G358_g7 - 0.5 ) * 0.25 ) + ( 1.0 - 0.25 ) ) ) + weightedBlendVar602_g7.w*saturate( ( ( ( Mask3G389_g7 - 0.5 ) * 0.25 ) + ( 1.0 - 0.25 ) ) ) );
				float Mask4G748_g7 = tex2DNode697_g7.g;
				float Mask5G742_g7 = tex2DNode704_g7.g;
				float Mask6G756_g7 = tex2DNode711_g7.g;
				float Mask7G766_g7 = tex2DNode717_g7.g;
				float4 weightedBlendVar799_g7 = Control1922_g7;
				float weightedBlend799_g7 = ( weightedBlendVar799_g7.x*saturate( ( ( ( Mask4G748_g7 - 0.5 ) * 0.25 ) + ( 1.0 - 0.25 ) ) ) + weightedBlendVar799_g7.y*saturate( ( ( ( Mask5G742_g7 - 0.5 ) * 0.25 ) + ( 1.0 - 0.25 ) ) ) + weightedBlendVar799_g7.z*saturate( ( ( ( Mask6G756_g7 - 0.5 ) * 0.25 ) + ( 1.0 - 0.25 ) ) ) + weightedBlendVar799_g7.w*saturate( ( ( ( Mask7G766_g7 - 0.5 ) * 0.25 ) + ( 1.0 - 0.25 ) ) ) );
				
				float2 uv_TerrainHolesTexture = packedInput.ase_texcoord6.zw * _TerrainHolesTexture_ST.xy + _TerrainHolesTexture_ST.zw;
				float4 tex2DNode451_g7 = SAMPLE_TEXTURE2D( _TerrainHolesTexture, sampler_TerrainHolesTexture, uv_TerrainHolesTexture );
				
				surfaceDescription.BaseColor = temp_output_1362_0.xyz;
				surfaceDescription.Normal = staticSwitch503_g7;
				surfaceDescription.BentNormal = float3( 0, 0, 1 );
				surfaceDescription.CoatMask = 0;
				surfaceDescription.Metallic = ( weightedBlend536_g7 + weightedBlend834_g7 );
				...
				surfaceDescription.Occlusion = saturate( ( weightedBlend602_g7 + weightedBlend799_g7 ) );
	...
	UsePass "Hidden/Nature/Terrain/Utilities/SELECTION"
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh  )
			{
				...
				float2 break291_g7 = _Control_ST.zw;
				float2 appendResult293_g7 = (float2(( break291_g7.x + 0.001 ) , ( break291_g7.y + 0.0001 )));
				float2 vertexToFrag286_g7 = ( ( inputMesh.uv0.xy * _Control_ST.xy ) + appendResult293_g7 );
				outputPackedVaryingsMeshToPS.ase_texcoord3.xy = vertexToFrag286_g7;
				float2 break951_g7 = _Control1_ST.zw;
				float2 appendResult956_g7 = (float2(( break951_g7.x + 0.001 ) , ( break951_g7.y + 0.0001 )));
				float2 vertexToFrag958_g7 = ( ( inputMesh.uv0.xy * _Control1_ST.xy ) + appendResult956_g7 );
				outputPackedVaryingsMeshToPS.ase_texcoord4.xy = vertexToFrag958_g7;
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				BuiltinData builtinData;
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float vertexPositionY22_g4 = packedInput.ase_texcoord2.xyz.y;
				float stripeResolution3_g4 = _StripeResolution;
				float currentContour34_g4 = ceil( ( vertexPositionY22_g4 * stripeResolution3_g4 ) );
				float currentColor65_g4 = ( 1.0 - ( currentContour34_g4 % 2.0 ) );
				int minorIndex30_g4 = _MajorIndex;
				...
				float4 weightedBlendVar473_g7 = Control26_g7;
				float3 weightedBlend473_g7 = ( weightedBlendVar473_g7.x*unpack490_g7 + weightedBlendVar473_g7.y*unpack496_g7 + weightedBlendVar473_g7.z*unpack494_g7 + weightedBlendVar473_g7.w*unpack491_g7 );
				float2 vertexToFrag958_g7 = packedInput.ase_texcoord4.xy;
				float4 Control1922_g7 = SAMPLE_TEXTURE2D( _Control1, sampler_Control1, vertexToFrag958_g7 );
	...
	UsePass "Hidden/Nature/Terrain/Utilities/SELECTION"
		...
		Pass
		{
			...
			AttributesMesh ApplyMeshModification(AttributesMesh inputMesh, float3 timeParameters, inout PackedVaryingsMeshToPS outputPackedVaryingsMeshToPS )
			{
				...
				float2 appendResult293_g7 = (float2(( break291_g7.x + 0.001 ) , ( break291_g7.y + 0.0001 )));
				float2 vertexToFrag286_g7 = ( ( inputMesh.ase_texcoord.xy * _Control_ST.xy ) + appendResult293_g7 );
				outputPackedVaryingsMeshToPS.ase_texcoord8.xy = vertexToFrag286_g7;
				float2 break951_g7 = _Control1_ST.zw;
				float2 appendResult956_g7 = (float2(( break951_g7.x + 0.001 ) , ( break951_g7.y + 0.0001 )));
				float2 vertexToFrag958_g7 = ( ( inputMesh.ase_texcoord.xy * _Control1_ST.xy ) + appendResult956_g7 );
				outputPackedVaryingsMeshToPS.ase_texcoord9.xy = vertexToFrag958_g7;
				
				outputPackedVaryingsMeshToPS.ase_texcoord7 = float4(inputMesh.positionOS,1);
				outputPackedVaryingsMeshToPS.ase_texcoord8.zw = inputMesh.ase_texcoord.xy;
						...
						)
			{
				...
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float vertexPositionY22_g4 = packedInput.ase_texcoord7.xyz.y;
				float stripeResolution3_g4 = _StripeResolution;
				float currentContour34_g4 = ceil( ( vertexPositionY22_g4 * stripeResolution3_g4 ) );
				float currentColor65_g4 = ( 1.0 - ( currentContour34_g4 % 2.0 ) );
				int minorIndex30_g4 = _MajorIndex;
				...
				float2 vertexToFrag286_g7 = packedInput.ase_texcoord8.xy;
				float4 Control26_g7 = SAMPLE_TEXTURE2D( _Control, sampler_Control, vertexToFrag286_g7 );
				float2 uv_Splat0 = packedInput.ase_texcoord8.zw * _Splat0_ST.xy + _Splat0_ST.zw;
				float4 Normal0341_g7 = SAMPLE_TEXTURE2D( _Normal0, sampler_Normal0, uv_Splat0 );
				float3 unpack490_g7 = UnpackNormalScale( Normal0341_g7, _NormalScale0 );
				unpack490_g7.z = lerp( 1, unpack490_g7.z, saturate(_NormalScale0) );
				float2 uv_Splat1 = packedInput.ase_texcoord8.zw * _Splat1_ST.xy + _Splat1_ST.zw;
				float4 Normal1378_g7 = SAMPLE_TEXTURE2D( _Normal1, sampler_Normal0, uv_Splat1 );
				float3 unpack496_g7 = UnpackNormalScale( Normal1378_g7, _NormalScale1 );
				unpack496_g7.z = lerp( 1, unpack496_g7.z, saturate(_NormalScale1) );
				float2 uv_Splat2 = packedInput.ase_texcoord8.zw * _Splat2_ST.xy + _Splat2_ST.zw;
				float4 Normal2356_g7 = SAMPLE_TEXTURE2D( _Normal2, sampler_Normal0, uv_Splat2 );
				float3 unpack494_g7 = UnpackNormalScale( Normal2356_g7, _NormalScale2 );
				unpack494_g7.z = lerp( 1, unpack494_g7.z, saturate(_NormalScale2) );
				float2 uv_Splat3 = packedInput.ase_texcoord8.zw * _Splat3_ST.xy + _Splat3_ST.zw;
				float4 Normal3398_g7 = SAMPLE_TEXTURE2D( _Normal3, sampler_Normal0, uv_Splat3 );
				float3 unpack491_g7 = UnpackNormalScale( Normal3398_g7, _NormalScale3 );
				unpack491_g7.z = lerp( 1, unpack491_g7.z, saturate(_NormalScale3) );
				float4 weightedBlendVar473_g7 = Control26_g7;
				float3 weightedBlend473_g7 = ( weightedBlendVar473_g7.x*unpack490_g7 + weightedBlendVar473_g7.y*unpack496_g7 + weightedBlendVar473_g7.z*unpack494_g7 + weightedBlendVar473_g7.w*unpack491_g7 );
				float2 vertexToFrag958_g7 = packedInput.ase_texcoord9.xy;
				float4 Control1922_g7 = SAMPLE_TEXTURE2D( _Control1, sampler_Control1, vertexToFrag958_g7 );
				float2 uv_Splat4 = packedInput.ase_texcoord8.zw * _Splat4_ST.xy + _Splat4_ST.zw;
				float4 Normal4746_g7 = SAMPLE_TEXTURE2D( _Normal4, sampler_Normal4, uv_Splat4 );
				float3 unpack856_g7 = UnpackNormalScale( Normal4746_g7, _NormalScale4 );
				unpack856_g7.z = lerp( 1, unpack856_g7.z, saturate(_NormalScale4) );
				float2 uv_Splat5 = packedInput.ase_texcoord8.zw * _Splat5_ST.xy + _Splat5_ST.zw;
				float4 Normal5740_g7 = SAMPLE_TEXTURE2D( _Normal5, sampler_Normal0, uv_Splat5 );
				float3 unpack857_g7 = UnpackNormalScale( Normal5740_g7, _NormalScale5 );
				unpack857_g7.z = lerp( 1, unpack857_g7.z, saturate(_NormalScale5) );
				float2 uv_Splat6 = packedInput.ase_texcoord8.zw * _Splat6_ST.xy + _Splat6_ST.zw;
				float4 Normal6754_g7 = SAMPLE_TEXTURE2D( _Normal6, sampler_Normal0, uv_Splat6 );
				float3 unpack858_g7 = UnpackNormalScale( Normal6754_g7, _NormalScale6 );
				unpack858_g7.z = lerp( 1, unpack858_g7.z, saturate(_NormalScale6) );
				float2 uv_Splat7 = packedInput.ase_texcoord8.zw * _Splat7_ST.xy + _Splat7_ST.zw;
				float4 Normal7764_g7 = SAMPLE_TEXTURE2D( _Normal7, sampler_Normal0, uv_Splat7 );
				float3 unpack854_g7 = UnpackNormalScale( Normal7764_g7, _NormalScale7 );
				unpack854_g7.z = lerp( 1, unpack854_g7.z, saturate(_NormalScale7) );
				float4 weightedBlendVar860_g7 = Control1922_g7;
				...
				float2 uv_TerrainHolesTexture = packedInput.ase_texcoord8.zw * _TerrainHolesTexture_ST.xy + _TerrainHolesTexture_ST.zw;
				float4 tex2DNode451_g7 = SAMPLE_TEXTURE2D( _TerrainHolesTexture, sampler_TerrainHolesTexture, uv_TerrainHolesTexture );
...
/*ASEBEGIN
Version=19303
Node;AmplifyShaderEditor.FunctionNode;1362;1888,-1088;Inherit;False;Indexed Alternating Colors;-1;;4;849960d891e2c14479cb46ab0a2cf3f9;0;3;28;INT;0;False;29;INT;0;False;2;FLOAT;5;False;1;FLOAT4;0
Node;AmplifyShaderEditor.FunctionNode;1360;1984,-960;Inherit;False;Terrain 8 Layer;0;;7;08d11189af276e64bad87e6cdb726c83;6,504,1,102,1,976,1,978,1,668,0,669,0;0;9;FLOAT3;0;FLOAT3;14;FLOAT;56;FLOAT;45;FLOAT;200;FLOAT;975;COLOR;979;FLOAT3;998;FLOAT4;999
Node;AmplifyShaderEditor.LerpOp;1363;2240,-1088;Inherit;False;3;0;FLOAT4;0,0,0,0;False;1;FLOAT4;0,0,0,0;False;2;FLOAT4;0,0,0,0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.RangedFloatNode;1370;1568,-976;Inherit;False;Property;_StripeResolution;Stripe Resolution;90;0;Create;True;0;0;0;False;0;False;0.2;0.2;0;5;0;1;FLOAT;0
Node;AmplifyShaderEditor.IntNode;1365;1664,-1072;Inherit;False;Property;_MinorIndex;Minor Index;92;0;Create;True;0;0;0;False;0;False;5;5;False;0;1;INT;0
Node;AmplifyShaderEditor.IntNode;1364;1664,-1152;Inherit;False;Property;_MajorIndex;Major Index;91;0;Create;True;0;0;0;False;0;False;10;10;False;0;1;INT;0
...
ASEEND*/
//CHKSM=7F6A65F490BA178C6FE0298BBF20899B53125AC7